...
//! # Reference plot
//!
//! The following SVG is generated by `cargo run -p fluxkit_math --example
//! plot_modulation -- docs/plots` and shows the phase-duty shape produced by
//! SPWM and SVPWM under comparable operating points.
