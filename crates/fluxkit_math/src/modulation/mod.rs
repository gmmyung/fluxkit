//! PWM modulation math.
//!
//! This module owns the averaged modulation layer between a stationary-frame
//! voltage request and normalized phase duty.
//!
//! # Reference plot
//!
...
#[cfg(test)]
mod tests {
    use super::{Modulator, SinePwm, Svpwm, dq_q_limit};
    ...
    fn invalid_limits_return_zero() {
        assert_eq!(SinePwm.linear_limit(Volts::new(0.0)), Volts::ZERO);
        assert_eq!(Svpwm.linear_limit(Volts::new(-1.0)), Volts::ZERO);
        assert_eq!(
